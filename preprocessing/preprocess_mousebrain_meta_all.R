...
##CB
subcluster_assign <- readRDS("../datasets/raw/MouseBrain/Drop-seq/F_GRCm38.81.P60Cerebellum_ALT.subcluster.assign.RDS")
...
cluster_assign_vec[which(cluster_assign_vec %in% paste("9-", 1:27, sep = ""))] <- "Choroid plexus"
cluster_assign_vec[which(cluster_assign_vec %in% paste("10-", 1:27, sep = ""))] <- "Endothelial stalk"
cluster_assign_vec[which(cluster_assign_vec %in% paste("11-", 1:2, sep = ""))] <- "Endothelial tip"
...
##FC
subcluster_assign <- readRDS("../datasets/raw/MouseBrain/Drop-seq/F_GRCm38.81.P60Cortex_noRep5_FRONTALonly.subcluster.assign.RDS")
cluster_assign_vec <- as.vector(as.factor(subcluster_assign))
names(cluster_assign_vec) <- names(subcluster_assign)
subcluster_assign_vec <- cluster_assign_vec
...
cluster_assign_vec[which(cluster_assign_vec %in% paste("12-", 1:27, sep = ""))] <- "Endothelial stalk"
cluster_assign_vec[which(cluster_assign_vec %in% paste("13-", 1:27, sep = ""))] <- "Mural"
cluster_assign_vec[which(cluster_assign_vec %in% paste("14-", 1:27, sep = ""))] <- "Endothelial tip"
...
##PC
subcluster_assign <- readRDS("../datasets/raw/MouseBrain/Drop-seq/F_GRCm38.81.P60Cortex_noRep5_POSTERIORonly.subcluster.assign.RDS")
cluster_assign_vec <- as.vector(as.factor(subcluster_assign))
names(cluster_assign_vec) <- names(subcluster_assign)
subcluster_assign_vec <- cluster_assign_vec
...
##ENT
subcluster_assign <- readRDS("../datasets/raw/MouseBrain/Drop-seq/F_GRCm38.81.P60EntoPeduncular.subcluster.assign.RDS")
cluster_assign_vec <- as.vector(as.factor(subcluster_assign))
names(cluster_assign_vec) <- names(subcluster_assign)
subcluster_assign_vec <- cluster_assign_vec
...
cluster_assign_vec[which(cluster_assign_vec %in% paste("2-", 1:27, sep = ""))] <- "Endothelial stalk"
cluster_assign_vec[which(cluster_assign_vec %in% paste("3-", c(1,3,4,5,6), sep = ""))] <- "Mural"
cluster_assign_vec[which(cluster_assign_vec %in% paste("3-", 2, sep = ""))] <- "Endothelial tip"
cluster_assign_vec[which(cluster_assign_vec %in% paste("4-", 1:27, sep = ""))] <- "Neuron"
...
##GP
subcluster_assign <- readRDS("../datasets/raw/MouseBrain/Drop-seq/F_GRCm38.81.P60GlobusPallidus.subcluster.assign.RDS")
cluster_assign_vec <- as.vector(as.factor(subcluster_assign))
names(cluster_assign_vec) <- names(subcluster_assign)
subcluster_assign_vec <- cluster_assign_vec
sort(unique(subcluster_assign_vec))
...
cluster_assign_vec[which(cluster_assign_vec %in% paste("7-", 1:27, sep = ""))] <- "Endothelial stalk"
cluster_assign_vec[which(cluster_assign_vec %in% paste("8-", 1:27, sep = ""))] <- "Mural"
cluster_assign_vec[which(cluster_assign_vec %in% paste("9-", 1:27, sep = ""))] <- "Endothelial tip"
...
##Hippo
subcluster_assign <- readRDS("../datasets/raw/MouseBrain/Drop-seq/F_GRCm38.81.P60Hippocampus.subcluster.assign.RDS")
cluster_assign_vec <- as.vector(as.factor(subcluster_assign))
names(cluster_assign_vec) <- names(subcluster_assign)
subcluster_assign_vec <- cluster_assign_vec
sort(unique(subcluster_assign_vec))
...
cluster_assign_vec[which(cluster_assign_vec %in% paste("12-", 1:27, sep = ""))] <- "Choroid plexus"
...
cluster_assign_vec[which(cluster_assign_vec %in% paste("15-", 1:27, sep = ""))] <- "Endothelial stalk"
cluster_assign_vec[which(cluster_assign_vec %in% paste("16-", 1:27, sep = ""))] <- "Mural"
cluster_assign_vec[which(cluster_assign_vec %in% paste("17-", 1:27, sep = ""))] <- "Endothelial tip"
...
##STR
subcluster_assign <- readRDS("../datasets/raw/MouseBrain/Drop-seq/F_GRCm38.81.P60Striatum.subcluster.assign.RDS")
cluster_assign_vec <- as.vector(as.factor(subcluster_assign))
names(cluster_assign_vec) <- names(subcluster_assign)
subcluster_assign_vec <- cluster_assign_vec
sort(unique(subcluster_assign_vec))
...
##SN
subcluster_assign <- readRDS("../datasets/raw/MouseBrain/Drop-seq/F_GRCm38.81.P60SubstantiaNigra.subcluster.assign.RDS")
cluster_assign_vec <- as.vector(as.factor(subcluster_assign))
names(cluster_assign_vec) <- names(subcluster_assign)
subcluster_assign_vec <- cluster_assign_vec
sort(unique(subcluster_assign_vec))
...
##TH
subcluster_assign <- readRDS("../datasets/raw/MouseBrain/Drop-seq/F_GRCm38.81.P60Thalamus.subcluster.assign.RDS")
cluster_assign_vec <- as.vector(as.factor(subcluster_assign))
names(cluster_assign_vec) <- names(subcluster_assign)
subcluster_assign_vec <- cluster_assign_vec
sort(unique(subcluster_assign_vec))
...
cluster_assign_vec[which(cluster_assign_vec %in% paste("2-", 1:27, sep = ""))] <- "Neuron"
cluster_assign_vec[which(cluster_assign_vec %in% paste("3-", 1:27, sep = ""))] <- "Neuron"
cluster_assign_vec[which(cluster_assign_vec %in% paste("4-", 1:27, sep = ""))] <- "Endothelial stalk"
cluster_assign_vec[which(cluster_assign_vec %in% paste("5-", 1:27, sep = ""))] <- "Mural"
cluster_assign_vec[which(cluster_assign_vec %in% paste("6-", 1:27, sep = ""))] <- "Endothelial tip"
...
save(meta_all, file="../datasets/raw/MouseBrain/Drop-seq_meta_all.RData")
